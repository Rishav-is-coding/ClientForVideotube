    ...
    <header className="sticky inset-x-0 top-0 z-50 w-full border-b bg-[#121212] px-4">
        ...
        <nav className="mx-auto flex max-w-7xl items-center py-2">
            <div className="mr-4 w-12 shrink-0 sm:w-16">
                <svg width= "100%" viewBox="0 0 63 64" fill= "none" xmlns="http://www.w3.org/2000/svg">
                    <path 
            ...
            <div>
                {/* for desktop */}
                {!authStatus ? (
                    <div className="hidden sm:flex mb-8 mt-auto w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
                        <Link to="/login">
                ...
                {/* sidebar */}
                {isOpen && (
                    <div className={`fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 flex-col border-l border-white bg-[#121212] transition-transform translate-x-0 sm:static sm:ml-4 sm:w-auto sm:border-none`}>
